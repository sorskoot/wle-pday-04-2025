...
export class Assert {
     ...
     */
    static hasKey<T extends object, K extends keyof T>(obj: T, key: K): asserts obj is T & Record<K, unknown> {
        if (!(key in obj)) {
     ...
     */
    static isInstanceOf<T>(value: unknown, constructor: new (...args: any[]) => T): asserts value is T {
